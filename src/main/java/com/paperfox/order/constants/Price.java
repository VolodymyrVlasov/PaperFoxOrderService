...
public class Price {
    ...
    public static final int[] UPM_PRINT_PRICE = new int[]{0};
    public static final int[] COLOR_COPY_PRINT_PRICE = new int[]{0};

    public static final double[] HAND_CUTTING_PRICE = new double[]{5, 4, 3, 2, 1};
